...
class MasterAggregator:
    ...
    def process_penutup(self):
        ...
        return {
            "perintah_pengundangan": m_perintah.group(1).strip() if m_perintah else "NONE", # Kunci baru
            "pengesahan": {
